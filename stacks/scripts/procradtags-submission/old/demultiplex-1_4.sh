...
barcodes=../info/barcodes_lane1_4.tsv
echo $barcodes

for i in ${list[@]}; do
        filepath1=$dir"P1_4_CKDL190143248-1a-4_H723VBBXX_L[$i]_1.fq.gz"
        echo $filepath1
        filepath2=$dir"P1_4_CKDL190143248-1a-4_H723VBBXX_L[$i]_2.fq.gz"
        echo $filepath2
        jobname=proc_radtags_[$i]_1_4
        echo $jobname
                ...
                -d /scratch/phyletica/distichus/samples/ \
                 -l walltime=48:00:00 << HereDoc
                        ...
                        process_radtags --paired -1 $filepath1 -2 $filepath2 -b $barcodes -o /scratch/phyletica/distichus/samples/ \
                                --renz_1 sbfI --renz_2 mspI --inline_null -c -q -r &> process_radtags.lane1_4.oe 
