...
barcodes=../info/barcodes_lane1_2.tsv
echo $barcodes

for i in ${list[@]}; do
        filepath1=$dir"P1_2_CKDL190143248-1a-2_H723VBBXX_L"$i"_1.fq.gz"
        echo $filepath1
        filepath2=$dir"P1_2_CKDL190143248-1a-2_H723VBBXX_L"$i"_2.fq.gz"
        echo $filepath2
        ...
        qsub -N $jobname \
			...
			module load stacks/2.41
                        ...
                        process_radtags --paired -1 $filepath1 -2 $filepath2 -b $barcodes -o /scratch/phyletica/distichus/samples/ \
                                --renz_1 sbfI --renz_2 mspI --inline_null -c -q -r &> process_radtags.lane1_2.oe 
