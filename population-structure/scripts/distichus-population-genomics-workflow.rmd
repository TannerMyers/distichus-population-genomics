...
sp_results <- as.matrix(read_table('north/north-subsp-_sp_xval_results.txt'))
sp_CIs <- apply(sp_results, 1, function(x){mean(x) + c(-1.96,1.96) * sd(x)/length(x)})


nsp_results <- as.matrix(read_table('north/north-subsp-_nsp_xval_results.txt'))
...
sp_results <- as.matrix(read_table('south/south-subsp-_sp_xval_results.txt'))
sp_CIs <- apply(sp_results, 1, function(x){mean(x) + c(-1.96,1.96) * sd(x)/length(x)})


nsp_results <- as.matrix(read_table('south/south-subsp-_nsp_xval_results.txt'))
nsp_CIs <- apply(nsp_results, 1, function(x){mean(x) + c(-1.96,1.96) * sd(x)/length(x)})
