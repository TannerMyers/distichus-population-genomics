...
# (1) Load allele frequencies file
    structure2conStruct(infile = "distichus-nohead.str",#"distichus-spgrp-North-Paleo-island-conStruct.str",
        onerowperind = TRUE,
        start.loci = 3,
        missing.datum = 0, # This data matrix lacks any missing data so I just chose 0
        outfile = "distichus-input")
load("distichus-input.RData")
...
RAD_data <- read_table("distichus-subsp-Hispaniola-popmap-cleaned.tsv", col_names = TRUE)
...
dir.create("/mmfs1/scratch/tcm0036/distichus-ddRAD/analyses/population-structure/conStruct/AnoDist_aln/distichus-subsp/outputs")
